      ...
      <div className="page-container">
        <div className="empty-state">
          ...
          <div className="empty-state__text">
            ...
            <br />
            Vérifie que les groupes sélectionnés ont des chansons.
          </div>
        ...
        <div className="blind-test-layout">
          <div>
            ...
            <div className="playback-controls">
              ...
              <button className="playback-btn" onClick={handleReplay} title="Rejouer">
                ↺
              </button>
              <button className="playback-btn" onClick={handleReveal} title="Arrêter">
                ⏹
              </button>
              <button className="playback-btn" onClick={goNext} title="Passer">
                ⏭
              </button>
            </div>
            ...
            <div className="answer-panel">
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' && !revealed) handleValidate();
                }}
                disabled={revealed}
              />
              <div className="answer-buttons">
                <button className="btn btn--primary" onClick={handleValidate} disabled={revealed || !answer.trim()}>
                  Valider
                </button>
                <button className="btn btn--secondary" onClick={revealed ? goNext : handleReveal}>

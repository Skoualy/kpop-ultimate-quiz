...
| Champ            | Options                                                           |
| ---------------- | ----------------------------------------------------------------- |
| **Type de quiz** | Save One / Blind Test / Tournoi _(disabled — bientôt disponible)_ |
...
### Section "Options supplémentaires" _(mode Personnalisé uniquement)_
...
- **Sélecteur de artistes** (dans une `ConfigCard` séparée à l'intérieur)
...
**Important :** les valeurs des filtres dynamiques (années, labels, générations) sont calculées sur **tous les artistes**, pas sur les artistes filtrés, pour ne pas fausser les options disponibles.
...
- Mode Personnalisé sans artiste sélectionné

Dans tous les autres cas : toujours actif (joue avec tous les artistes disponibles).
...
| `FilterBadgeGroupControl<T>` | Control       | Filtres Gen/Cat artistes (wrapper logique → délègue le rendu à `BadgeGroupControl`) |
| `ConfigCard`                 | PureComponent | Wrapper de bloc de configuration                                                    |
| `LoadingSpinner`             | Component     | Chargement des artistes                                                             |
...
| Field         | Options                                                       |
| ------------- | ------------------------------------------------------------- |
| **Quiz type** | Save One / Blind Test / Tournament _(disabled — coming soon)_ |
| **Category**  | Idols / Songs                                                 |
...
### "Additional options" section _(Custom mode only)_
